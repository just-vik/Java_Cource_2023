...
//                size--;
                // можно написать этот код короче
                employees[i] = employees[--size]; // -- префиксная операция
                employees[size] = null; // обнуляем последний
                return victim;
            }
        }
        return null;
...
//    - потом создать массив под это количество, и только потом его заполнить.
...
//    Тестирование методов возвращающих массив, осуществляется при помощи assertArrayEquals.
    ...
    public Employee[] findEmployeesHoursGreaterThan(int hours) {
        ...
        //заполняем массив res (прописываем 2е значение j = 0)
