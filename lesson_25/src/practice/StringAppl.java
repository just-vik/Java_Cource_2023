...
public class StringAppl {
    public static void main(String[] args) {
        ...
        str = str.concat(str1);  //аналогичная операция, добавил еще слово world
        System.out.println(str);
        ...
        System.out.println(str1.equalsIgnoreCase(str2));//игнорирует регистр букв
...
//        index -позиция символа в строке
        ...
        index = str.indexOf("world");//с какого index начинается подстрока or
        System.out.println(index);
        index = str.indexOf('l', 4);//ищем "l" начиная с 4 индекса в строке
        System.out.println(index);
        ...
        System.out.println("-------------------------------------------");
        System.out.println(str.substring(4));//печатаем подстроку с 4 индекса
        System.out.println(str.substring(1, 8));//печатаем подстроку с 1 по 8 элементы (1 захватывает, 8 не захватывает)
        System.out.println(str.replace("o", "o-o-o"));//поиск с заменой
        ...
        String[] words = str5.split(" "); //задаем массив String, разделяем строку на элементы массива
        ...
        String[] letters=str6.split(""); //разделителя нет, чтобы получит буквы
