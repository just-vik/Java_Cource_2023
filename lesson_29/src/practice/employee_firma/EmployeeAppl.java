...
//        создаем сотрудников
        ...
        double total = totalSalary(empl); //вызываем метод для расчета з\п
        System.out.println("Total salary: " + total);
        double average = averageAge(empl); //вызываем метод для расчета среднего возраста
        System.out.println("Average age: " + average);

    }

    //        считаем для них общую з\п
