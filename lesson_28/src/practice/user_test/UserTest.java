...
class UserTest {
    ...
    User user;
    final String email = "peter@mail.com"; // final - переменная не меняется
    ...
    void setWithoutAt() {
        ...
        assertEquals(email,user.getEmail());//если они совпадут этот значит что email не установился а остался прежним
