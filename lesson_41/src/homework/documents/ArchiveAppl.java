...
import homework.documents.dao.Archive;
import homework.documents.dao.ArchiveImpl;
import homework.documents.model.Document;
import homework.documents.model.MenuDocs;
...
public class ArchiveAppl {
    public static void main(String[] args) {
        ...
        while (true) {
            // print menu
            MenuDocs.printMenu(); // статический метод вызывается по имени класса
            // ask choice
