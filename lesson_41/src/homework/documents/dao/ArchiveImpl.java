...
// с использованием List & ArrayList
//    public Document[] getDocumentsBetweenDates(LocalDate dateFrom, LocalDate dateTo) {
//        List<Document> result = new ArrayList<>();
//        for (Document doc : documents) {
//            if (doc != null && isDateInRange(doc.getDate(), dateFrom, dateTo)) {
//                result.add(doc);
//            }
//        }
//        return result.toArray(new Document[result.size()]);
//    }
//    private boolean isDateInRange(LocalDateTime documentDate, LocalDate dateFrom, LocalDate dateTo) {
//        return documentDate.toLocalDate().isAfter(dateFrom) && documentDate.toLocalDate().isBefore(dateTo);
//    }
