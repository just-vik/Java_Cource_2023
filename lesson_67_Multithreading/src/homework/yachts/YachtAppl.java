...
public class YachtAppl {
    public static void main(String[] args) {
        ...
        yachts.add(new Yacht("shipyard 1", 2004, 20.5, "plastic", 100_000));
        yachts.add(new Yacht("shipyard 2", 2009, 18.2, "wood", 230_000));
        yachts.add(new Yacht("shipyard 3", 2016, 25.0, "metal", 310_000));
        yachts.add(new Yacht("shipyard 4", 2021, 22.8, "wood", 490_000));
