...
public class CastingAppl {
    public static void main(String[] args) {
        ...
        if (lap1 instanceof Laptop) { //проверка перед кастингом
            Laptop laptop1 = (Laptop) lap1; //down casting from Computer to Laptop
            laptop1.setHours(4.5);
            System.out.println(laptop1);
            System.out.println(lap1);
        }
        Computer smart1 = new Smartphone("Snapdragon", 8, 128, "Samsung", 24, 0.15, 123456789);
        ...
        if (lap1 instanceof Smartphone) {
            ...
            System.out.println("Lap1 not Smartphone");
        }
    }
}
