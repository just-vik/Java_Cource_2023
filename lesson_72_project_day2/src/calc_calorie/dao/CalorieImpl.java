...
public class CalorieImpl implements Calorie{
    ...
    public List<Product> readProductsFromCSV() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("src/calc_calorie/Product.csv"))) {
            String line;
    ...
    public void saveFood(List <Product> products) {
        String filePath = "src/calc_calorie/saved_food.txt";
    ...
    public List<Product> loadFood() {
        ...
        String filePath = "src/calc_calorie/saved_food.txt"; // Укажите полный путь к файлу
